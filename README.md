...
3. **Set up CI plumbing.** Add the `Makefile`, `lefthook.yml`, and `.github/workflows/` entries described in `docs/convention/ci.md`, so local and CI runs invoke the same commands.
